...
def add_inline_math(node):
    """The math output are ignored by sphinx in the output generated by the theme.
    This method returns the html translation of a math node to hydrate the html
    output generated by this file.
