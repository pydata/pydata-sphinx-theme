...
(() => {
  // Define custom icons for
  const customIconDefinitions = [
    // Custom icon for PyPI because it is not in FontAwesome's built-in brand
    // icons
    {
      prefix: "fa-custom",
      iconName: "pypi",
      icon: [
        ...
        // svg path (https://simpleicons.org/icons/pypi.svg)
  ...
  // Register the custom icons with FontAwesome so they can be used just like
  // other FontAwesome icons.
  FontAwesome.library.add(customIconDefinitions);
})();
