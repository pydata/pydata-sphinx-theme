...
function macroTemplate({ compilation }) {
  ...
  const stylesheet = (css) => {
    return `\
<link id="colors-css" href="{{ pathto('_static/css/light-theme.css', 1) }}" rel="stylesheet">
  ...
  const pygment = `<link id="pygment-css" href="{{ pathto('_static/css/light-pygment.css', 1) }}" rel="stylesheet">`
...
module.exports = {
  ...
  plugins: [
    new CleanWebpackPlugin({
      cleanOnceBeforeBuildPatterns: ['**/*', '!css', '!css/theme.css', '!css/blank.css', '!css/light-theme.css', '!css/dark-theme.css', '!css/dark-pygment.css', '!css/light-pygment.css'],
    }),
