...
..
   This test fixture is a modified copy of the Kitchen Sink - Blocks page. It is
   used to test the PyData Sphinx Theme feature that syncs the page table of contents
   with the user's scroll position on the page.
