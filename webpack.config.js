...
var config = {
  ...
  entry: {
    ...
    "nbsphinx-code-cells": resolve(scriptPath, "..", "styles", "nbsphinx-code-cells.scss")
  },
  output: {
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
      filename: (pd) => {
        const {chunk: { name }} = pd;
        console.log('afaoeunthaoeusthaeosuthaeostuhaeosntuhsaenohusnaethusnthaeou')
        console.log(pd)
        if (name === "nbsphinx-code-cells") {
          return `${name}.css`;
        } else {
